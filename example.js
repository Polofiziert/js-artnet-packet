...
const {ArtNetInstance} = require("./lib/artnet");
...
const {FieldIpAddr, FieldNetSwitch, FieldVersionInfo} = require("./lib/packets/fields");
...
const testBuf = Buffer.alloc(24)
var testOffset = 0
console.log(testBuf)
var ipAddress = "192.168.1.102"
var versionInfo = "1.10"
var netSwitch = "233"


ipField = new FieldIpAddr(ipAddress)
versInfField = new FieldVersionInfo(versionInfo)
netSwitchField = new FieldNetSwitch(netSwitch)



console.log(ipField)
testOffset = ipField.toBuffer(testBuf, 0)
console.log(testBuf)
console.log("-------------")

console.log(versInfField)
testOffset = versInfField.toBuffer(testBuf, testOffset)
console.log(testBuf)
console.log("-------------")

console.log(netSwitchField)
testOffset = netSwitchField.toBuffer(testBuf, testOffset)
console.log(testBuf)
