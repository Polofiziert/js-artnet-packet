...
class ArtPollReplyPacket extends ArtNetMinPacket {
    constructor(){
        ...
        this.fields = {
            ...
            portTypes : {  // 4 times
                ...
                canInput : true,  // Can Input ArtNet
                protocol : {
                    dmx512 : [false, 0],
                    midi : [false, 1],
                    avab : [false, 2],
    ...
    toBuffer() {
        ...
        offset = buf.writeInt8(data.versionInfoH, offset)
        offset = buf.writeInt8(data.versionInfoL, offset)
        // Port Address | field 7-8 2xInt8
        offset = buf.writeInt8(data.netSwitch, offset)
        offset = buf.writeInt8(data.subSwitch, offset)
        // Oem | field 9-10 H-L 2xInt8
        offset = buf.writeInt8(data.oemHi, offset)
        offset = buf.writeInt8(data.oemLo, offset)
        // Ubea Version | field 11 Int8
        offset = buf.writeInt8(data.ubeaVersion, offset)
        ...
        offset = buf.writeInt8(status1Int, offset)

        console.log("___**_____________*_____*_____")

        // EstaMan | field 13-14 Lo-Hi 2xint8
        offset = buf.writeInt8(data.estaManLo, offset)
        offset = buf.writeInt8(data.estaManHi, offset)
        ...
        offset = buf.writeInt8(data.numPortsHi, offset)
        offset = buf.writeInt8(data.numPortsLo, offset)
