...
const {ArtPollPacket} = require("../packets/");
...
test('ArtPollPacket obj works corectly', (t) => {
    t.test('Object is createt and filled corectly | opCode 0x2000 [0]', () => {
        ...
        assert.strictEqual(artPoll.opCode, 0x2000);
    });

    t.test('toBuffer func works corectly', (t) => {
        var artPoll = new ArtPollPacket()
        var bufExpected = Buffer.from([0x41, 0x72, 0x74, 0x2d, 0x4e, 0x65, 0x74, 0x00, 0x00, 0x20, 0x00, 0x0e, 0x06, 0x00, 0x7f, 0xff, 0x00, 0x00, 0x53, 0x79, 0x22, 0x69])
