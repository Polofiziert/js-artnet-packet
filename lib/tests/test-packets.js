...
test('ArtNetMinPacket obj works corectly', (t) => {
    t.test('Object is createt and filled corectly | opCode 0x2000 [0]', () => {
        ...
        assert.strictEqual(artMinPack.id, "Art-Net\0"); // tests if the properties of the created obj populted corectly
...
test('ArtNetPacket obj works corectly', (t) => {
    t.test('Object is created and filled corectly | opCode 0x2000 [0]', () => {
        ...
        assert.strictEqual(artPack.id, "Art-Net\0"); // tests if the properties of the created obj populted corectly
